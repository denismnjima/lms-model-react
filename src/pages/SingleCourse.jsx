...
const SingleCourse = () => {
  ...
  const toggleModule = async (moduleId) => {
    if (expandedModuleId === moduleId) {
      ...
      setModules((prevModules) =>
        prevModules.map((mod) =>
          mod.module_id === moduleId ? { ...mod, submodules } : mod
        )
      );
  ...
  return (
    <div className="p-6 bg-white shadow-md rounded-md max-w-2xl mx-auto">
      ...
      <AddModule courseId={courseId} onModuleAdded={fetchModules} />
        ...
        <div key={module.module_id} className="border-b border-gray-200 pb-4 mb-4">
          ...
          {expandedModuleId === module.module_id && (
            <div className="mt-2">
              ...
              {/* AddSubmodule form */}
              <AddSubmodule moduleId={module.module_id} onSubmoduleAdded={() => toggleModule(module.module_id)} />
            </div>
          )}
        </div>
      ))}
